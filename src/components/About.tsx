      ...
      <div className = "about-container">
        ...
        <div className = "description">
          ...
          <p>
            ...
            off making small 2D games using a special language called DM from
          ...
          <p>
            I then moved over to using Python and made applications for random people on discord servers
          ...
          <p>
            After COVID-19 hit I was let go and decided now was the best time for me to do everything in my power to
